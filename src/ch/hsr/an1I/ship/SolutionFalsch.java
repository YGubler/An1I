...
public class SolutionFalsch extends Solution {
    ...
    public void initialize() {
        ...
        // Die von PolynomialSplineFunction.getPolynomials() zurückgegebenen
        // Spline-Polynome müssen nach der Dokuemtation
    ...
    public void onSensorDataAvailable(Steering shipSteering, Sensor shipSensor) {
        ...
        for (int i = 0; i < splinePols.length; i++) {
            ...
            try {
                ...
                // Falls es Nullstellen gibt, so müssen diese auch im
